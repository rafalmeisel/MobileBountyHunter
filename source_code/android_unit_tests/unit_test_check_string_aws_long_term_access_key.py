...
module_path = 'source_code/android_tests/check_string_aws_long_term_access_key.py'

spec = importlib.util.spec_from_file_location('check_string_aws_long_term_access_key', module_path)
module = importlib.util.module_from_spec(spec)
spec.loader.exec_module(module)
check_string_aws_long_term_access_key = module.check_string_aws_long_term_access_key
...
class TestCheckStringCloudinary(unittest.TestCase):   
    ...
    def test_check_string_aws_long_term_access_key_empty_file(self):
        self.content_file = ""
        result = check_string_aws_long_term_access_key(self.content_file)
        expected = []
        self.assertEqual(result, expected)
    ...
    def test_check_string_aws_long_term_access_key_without_elements(self):
        self.content_file = '''
        <?xml version="1.0" encoding="utf-8"?>
            <resources>
                <string name="app_name">My App</string>
    ...
    def test_check_string_aws_long_term_access_key_many_values(self):
        self.content_file = '''
        <?xml version="1.0" encoding="utf-8"?>
            <resources>
                <string name="app_name">My App</string>
    ...
    def test_check_string_aws_long_term_access_key_wrong_value_too_short(self):
        self.content_file = '''
        <?xml version="1.0" encoding="utf-8"?>
            <resources>
                <string name="app_name">My App</string>
