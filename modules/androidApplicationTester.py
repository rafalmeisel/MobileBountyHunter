...
def runAndroidTests(OUTPUT_DIRECTORY_PATH, RESULT_FILE_PATH):
    ...
    for APPLICATION_PACKAGE_NAME in outputDirectoryApplicationPackageNames:
        ...
        checksResValuesStringsAwsAkid(OUTPUT_DIRECTORY_PATH, APPLICATION_PACKAGE_NAME, ANDROID_RES_VALUES_STRINGS_RELATIVE_FILE_PATH, RESULT_FILE_PATH)
        checksResValuesStringsAwSecretKey(OUTPUT_DIRECTORY_PATH, APPLICATION_PACKAGE_NAME, ANDROID_RES_VALUES_STRINGS_RELATIVE_FILE_PATH, RESULT_FILE_PATH)
