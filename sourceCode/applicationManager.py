...
def decompileExtentionApk(INPUT_DIRECTORY_PATH, APPLICATION_PACKAGE_NAME_FILE, OUTPUT_DIRECTORY_PATH):
    decompileApkWithJadx(INPUT_DIRECTORY_PATH, APPLICATION_PACKAGE_NAME_FILE, OUTPUT_DIRECTORY_PATH)
    # decompileApkWithApkTools(INPUT_DIRECTORY_PATH, APPLICATION_PACKAGE_NAME_FILE, OUTPUT_DIRECTORY_PATH)

def decompileExtentionXapk(INPUT_DIRECTORY_PATH, APPLICATION_PACKAGE_NAME_FILE, OUTPUT_DIRECTORY_PATH):
    ...
    if checkIfXapkIsValid(INPUT_DIRECTORY_PATH, APPLICATION_PACKAGE_NAME_FILE):
        ...
        decompileExtentionApk(INPUT_DIRECTORY_PATH + "XAPK_TEMP/" + APPLICATION_PACKAGE_NAME_FILE + "/", APPLICATION_PACKAGE_NAME_FILE, OUTPUT_DIRECTORY_PATH)
...
def decompileSingleApplicationPackage(INPUT_DIRECTORY_PATH, APPLICATION_PACKAGE_NAME_FILE, OUTPUT_DIRECTORY_PATH): 
    ...
    if ".xapk" in APPLICATION_PACKAGE_NAME_FILE:
        decompileExtentionXapk(INPUT_DIRECTORY_PATH, APPLICATION_PACKAGE_NAME_FILE, OUTPUT_DIRECTORY_PATH)
    elif ".apk" in APPLICATION_PACKAGE_NAME_FILE:
        decompileExtentionApk(INPUT_DIRECTORY_PATH, APPLICATION_PACKAGE_NAME_FILE, OUTPUT_DIRECTORY_PATH)
